...
@Component({
  selector: 'app-suggestionresponse',
  templateUrl: './suggestionresponse.component.html',
  styleUrls: ['./suggestionresponse.component.css']
})
export class SuggestionresponseComponent {
  id:any;
  forum:any;
  query:any;
  response:any;
 ...
 readData(){
    ...
    this.ds.getsuggeById(this.id).subscribe({
 ...
 AddSuggestion(res:string){
  if (this.forum && this.forum.responses){
    ...
    this.ds.postrespone(this.forum).subscribe(
      {
        next:(data:any)=>{
